 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         '&O,;a8ry=Cjv:0J}bnD2JJxAbd,Aecb@HX>7Z*D;%D1Wz6WY|0<4Gc4AN+7Ve5Kf' );
define( 'SECURE_AUTH_KEY',  'T^ 17B(8C6inp7XEz^<&=>zDyMB|nr6sFp+YRZ{(Nd$yS>Tuuj[;A&Ph2)llwX6.' );
define( 'LOGGED_IN_KEY',    '10qgL<rV++7vzuxV*y4^^Dc?y&+?{xe@3pkpF~TE8*??F10.MTF#;.*9hlgJZ?;;' );
define( 'NONCE_KEY',        '-8cH[xs?eFCJTrZ?<)Avl0o[]fcn8dhe8_mJNE6d@ECQ(w4v-{)SutfH4cJ:Z$PK' );
define( 'AUTH_SALT',        'me {y60]x{rtaQ.oN.vO@&qg/bOMF!CoMItj4G7t3>+77-3{CY6Yc+)(.X#v((:b' );
define( 'SECURE_AUTH_SALT', 'x6MI1RWqm~*8[>7RPP}Z@L}D>rih|8,VC1,R;h6iSwe%v*aH~7ht{}?zwq_Aj3(`' );
define( 'LOGGED_IN_SALT',   'Zr06=$H8%90xYGv1(9cagJAm]L4:~Qwyx#]TD|s,`quy^JEO1-/xaaN/faC0p!AN' );
define( 'NONCE_SALT',       'w9c;n2%X?^z/k6J,Jt$YBw{dP<Cxl#J{Bf3b@S;2doKw0aFNcT3oPfpyET8Q-:=L' );
